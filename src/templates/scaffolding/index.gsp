...
<html>
	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				<li><a class="btn btn-warning" href="\${createLink(uri: '/')}"><g:message code="default.home.label"/></a></li>
		...
		<div id="list-${domainClass.propertyName}" class="content scaffold-list" role="main">
			...
			<script>
				\$(".step").addClass("btn btn-xs btn-default");
				\$(".currentStep").addClass("btn btn-xs btn-warning btn-disabled");
				\$(".nextLink").addClass("btn btn-xs btn-default");
				\$(".prevLink").addClass("btn btn-xs btn-default");
